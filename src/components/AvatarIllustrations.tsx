...
const ILLUSTRATIONS: Record<AvatarVariant, (props: SVGProps<SVGSVGElement>) => JSX.Element> = {
  ...
  "teen-m": (props) => (
    <svg viewBox="0 0 64 64" {...props}>
      ...
      <path d="M32 40l6 6-6 6-6-6z" fill="#33C7C0" opacity="0.9" />
    </svg>
  ),
  "teen-f": (props) => (
    <svg viewBox="0 0 64 64" {...props}>
      ...
      <path d="M32 40l6 6-6 6-6-6z" fill="#F5B942" opacity="0.9" />
    </svg>
  ),
  "adult-m": (props) => (
    <svg viewBox="0 0 64 64" {...props}>
      ...
      <rect x="26" y="44" width="12" height="4" rx="2" fill="#33C7C0" />
    </svg>
  ),
  "adult-f": (props) => (
    <svg viewBox="0 0 64 64" {...props}>
      ...
      <rect x="26" y="44" width="12" height="4" rx="2" fill="#F5B942" />
    </svg>
  ),
};
