...
export function createDemoData(): AppData {
  ...
  const tasks: Task[] = [
    ...
    t(laura, "Huiswerk vóór gamen of tv", "school", "16:00", school, 10),
    t(laura, "Telefoon tijdens het eten weg", "scherm", "18:00", week, 5),
    ...
    t(milan, "Telefoon/tablet tijdens het eten weg", "scherm", "18:00", week, 5),
    t(milan, "Buiten spelen of sporten", "beweging", "16:30", week, 10),
    t(milan, "Speelgoed opruimen", "huishouden", "19:00", week, 5),
